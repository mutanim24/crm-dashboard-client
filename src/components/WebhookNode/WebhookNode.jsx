...
const WebhookNode = ({ data, selected }) => {
  return (
    <div className={`px-6 py-4 bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-xl shadow-lg border-2 ${
      selected ? 'border-yellow-400 ring-2 ring-yellow-400 ring-opacity-50' : 'border-teal-700'
