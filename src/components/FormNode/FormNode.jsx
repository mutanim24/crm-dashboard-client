...
const FormNode = ({ data, selected }) => {
  return (
    <div className={`px-6 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl shadow-lg border-2 ${
      selected ? 'border-yellow-400 ring-2 ring-yellow-400 ring-opacity-50' : 'border-purple-700'
